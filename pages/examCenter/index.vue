  ...
  <div>
    <el-card class="box-card">
      <el-table :data="tableData" stripe size="mini">
        ...
        <el-table-column prop="testQuestionsum" label="题量" width="50px;"></el-table-column>
        ...
        <el-table-column label="操作" width="100px;">
          <template v-slot:default="scope">
            ...
            <el-button
              ...
              type="success"
              round
            ><nuxt-link :to="{name: 'test-id', params: {testId: scope.row.testId}}" style="text-decoration: none;color:#666666;">进入考试</nuxt-link></el-button>
